...
function Modal({ open, children,title,onClose }) {
  return ( open && (
    <div className="fixed backdrop-blur-sm bg-Gray-6 h-screen w-full top-0 left-0 bg-opacity-30">
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-xl w-[calc(100vw-1rem)] max-w-[20rem] max-h-[calc(100vh-2rem)] overflow-auto bg-transparent shadow-lg transition-all duration-500 ease-out ">
