...
import Foodmenupagetwo from "../ui/Foodmenupagetwo";
import Loading from "../ui/Loading";
import Totalprice from "../ui/Totalprice";

function OrderStep_2({Setstep}) {
  ...
  return (
    <div className="mb-8">
      <div className="flex items-center justify-center my-6">
        <img src="../../public/photo/Position.png" alt="" />
      </div>

      <div className="w-full flex flex-row-reverse">
        <div className="w-2/5  border p-6 rounded-lg h-fit ">
    ...
    <div className="border-2 rounded-lg overflow-y-auto  px-3   ml-2 h-[40rem]"> 
      <Foodmenupagetwo /></div>
      </div>
    </div>
  );
